...
def Main(Revision: str = "r1") -> int:
    ...
    RunManifest = {
        ...
        "revision": Revision,
        "lineage": {
            "supersedes": "E01-R1" if Revision != "r1" else None,
            "reason": (
            ...
            "prior_outputs_preserved": Revision != "r1",
        },
...
if __name__ == "__main__":
    ...
    Parser.add_argument("--revision", default="r1", choices=("r1", "r2"))
