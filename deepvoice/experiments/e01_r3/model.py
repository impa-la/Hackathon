...
class LogMelCnn(nn.Module):
    ...
    def forward(
        ...
        # Real PCM amplitudes can overflow FP16 power/variance. Keep waveform,
        # STFT, mel projection and valid-only normalization in FP32; only the
        # compact CNN participates in the caller's autocast region.
