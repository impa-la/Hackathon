...
실행 시각: 2026-08-30 20:06:08 +0900
...
mask audit는 `train_plus_validation_no_test` 범위의 20개 dataset-head 조합을 확인했다. test 행의 label과 metadata는 읽거나 집계하지 않았다. 정확한 관측·mask 수는 `e00-r2-label-mask-audit.csv`에 있다.
...
- 총 wall time: 55.189초
- GPU time: 0시간
- 최대 논리 CPU 기준 비용 상한: 0.183962 CPU-hour
